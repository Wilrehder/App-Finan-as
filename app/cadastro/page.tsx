...
export default function CadastroPage(props: { searchParams: Promise<{ error?: string }> }) {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center p-6 bg-black overflow-hidden">
      ...
      <div className="pointer-events-none absolute bottom-0 right-1/4 w-[300px] h-[300px] bg-primary/10 rounded-full blur-[100px]" />
      ...
      <div className="relative w-full max-w-sm bg-zinc-900/80 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl p-8 space-y-7">
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <div>
            <h1 className="text-2xl font-extrabold tracking-tight text-white">Criar sua conta</h1>
        ...
        <div className="relative flex items-center gap-3">
          ...
          <span className="text-[11px] uppercase tracking-widest text-zinc-600 font-medium whitespace-nowrap">ou cadastre-se com e-mail</span>
          <div className="flex-1 h-px bg-white/8" />
        </div>
