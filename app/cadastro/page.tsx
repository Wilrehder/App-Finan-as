        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-background px-2 text-muted-foreground glass rounded-lg">Ou cadastre-se com e-mail</span>
            </div>
          </div>
          ...
          <SubmitButton defaultText="Criar Conta" pendingText="Criando..." />
          </form>
        </div>
